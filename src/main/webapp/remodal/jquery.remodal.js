...
;(function ($) {
    ...
    Remodal.prototype.buildDOM = function () {
        ...
        this.modalClose1 = $("<a href='#'>").addClass(pluginName + "-close1");
        ...
        this.modal.append(this.modalClose1);
    ...
    Remodal.prototype.addEventListeners = function () {
        ...
        this.modalClose1.bind("click." + pluginName, function (e) {
            e.preventDefault();
            this.close();
        }.bind(this));
    ...
    Remodal.prototype.close = function () {
        ...
        /*$("#confirmmodal").css("padding-top", "110px");*/
        try {
            $('#videoplayerconfirm'+loopindex.value).css('display', 'none');
